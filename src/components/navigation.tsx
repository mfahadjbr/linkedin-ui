      ...
      <nav className="fixed top-0 w-full bg-white/95 backdrop-blur-md z-50 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-3 sm:py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex lg:hidden items-center justify-center flex-1 gap-4 md:gap-5 mx-4 md:mx-6">
            <a href="/features" className="text-gray-700 hover:text-blue-600 transition text-sm md:text-base font-medium py-1 px-2 rounded-lg hover:bg-gray-50 active:bg-gray-100 touch-manipulation min-h-[44px] flex items-center">
              Features
            </a>
            <a href="/about" className="text-gray-700 hover:text-blue-600 transition text-sm md:text-base font-medium py-1 px-2 rounded-lg hover:bg-gray-50 active:bg-gray-100 touch-manipulation min-h-[44px] flex items-center">
              About Us
            </a>
            <a href="/contact" className="text-gray-700 hover:text-blue-600 transition text-sm md:text-base font-medium py-1 px-2 rounded-lg hover:bg-gray-50 active:bg-gray-100 touch-manipulation min-h-[44px] flex items-center">
              Contact Us
            </a>
          </div>
          ...
          <div className="hidden lg:flex items-center gap-6 xl:gap-8">
            <a href="/features" className="text-gray-700 hover:text-blue-600 transition text-sm xl:text-base font-medium py-1 px-2 rounded-lg hover:bg-gray-50 active:bg-gray-100">
              Features
            </a>
            <a href="/about" className="text-gray-700 hover:text-blue-600 transition text-sm xl:text-base font-medium py-1 px-2 rounded-lg hover:bg-gray-50 active:bg-gray-100">
              About Us
            </a>
            <a href="/contact" className="text-gray-700 hover:text-blue-600 transition text-sm xl:text-base font-medium py-1 px-2 rounded-lg hover:bg-gray-50 active:bg-gray-100">
              Contact Us
            </a>
          </div>
